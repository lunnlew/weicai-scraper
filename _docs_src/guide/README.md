...
|  操作系统  |         二进制包          |
| :----: | :-------------------: |
| winx64 |   [微采助手-Setup-x86-0.1.5.exe](https://github.com/lunnlew/weicai-scraper/releases/download/v0.1.5/Setup-x86-0.1.5.exe)   |
...
### 监控模式
目前软件支持对微信进行公众号文章推送数据的监控及采集，打开软件就自动启动该功能，注意：需要先运行微信客户端并登录，再运行本软件该机制才会生效。
